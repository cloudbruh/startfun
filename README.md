...
Самый простой способ запустить наше приложение локально - скачать репозиторий [trustartup-nginx](https://github.com/cloudbruh/trustartup-nginx) и следовать инструкции в ней
